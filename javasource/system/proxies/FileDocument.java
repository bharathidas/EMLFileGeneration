...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("EMLFileGeneration.Attachment", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("EMLFileGeneration.OutputDoc", mendixObject.getType())) {
